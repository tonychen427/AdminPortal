<%-- 
    Document   : adminLTE
    Created on : May 11, 2016, 1:35:56 PM
    Author     : tchen
--%>
...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="bower_components/adminlte-bower/dist/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="bower_components/adminlte-bower/dist/css/skins/_all-skins.min.css">
    <!-- iCheck -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- AdminLTE App -->
    <script src="bower_components/adminlte-bower/dist/js/app.min.js"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="bower_components/adminlte-bower/dist/js/pages/dashboard.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="bower_components/adminlte-bower/dist/js/demo.js"></script>
  </body>
</html>
